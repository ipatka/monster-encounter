...
interface MonsterEncountersInterface extends ethers.utils.Interface {
  functions: {
...
export class MonsterEncounters extends Contract {
  ...
  interface: MonsterEncountersInterface;
